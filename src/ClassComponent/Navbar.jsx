...
export default class NavbNamear extends Component {
    changeSearch(e) {
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form className="d-flex w-100" role="search">
                                <input className="form-control me-2" type="text" id='search' name='search' onChange={(e) => this.changeSearch(e)} placeholder="Search News" />
                            </form>
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item dropdown">
                                    <Link className="nav-link text-light dropdown-toggle" to="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
